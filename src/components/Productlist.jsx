...
function Productlist() {
  return (
    ...
    <br />
    <br />
    <div class="d-flex justify-content-start container mt-5 flex-direction: column">
        <div class="card p-3 bg-white"><i class="fa fa-apple"></i>
            <div class="about-product text-center mt-2">
              <img class="rounded" src="src/assets/photos/droneabouut.jpeg" width="300"/>
                <div>
            ...
            <button type="button" class="btn btn-outline-success"><h4>BUY  NOW</h4></button>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-start container mt-5">
        <div class="card p-3 bg-white"><i class="fa fa-apple"></i>
            <div class="about-product text-center mt-2">
              <img src="https://i.imgur.com/3VTaSeb.png" width="300"/>
                <div>
